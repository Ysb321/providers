...
// In-memory Key-Value Store fallback. The host app injects its own persistent
// kvStore at runtime; this default lets providers run standalone during testing.
function createInMemoryKvStore() {
...
export const providerContext: ProviderContext = {
  ...
  openWebView: async () => {
    throw new Error(
      "openWebView is not available in this context; the host app injects it at runtime.",
    );
  },
};
